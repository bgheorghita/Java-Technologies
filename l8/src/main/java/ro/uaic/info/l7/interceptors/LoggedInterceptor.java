...
public class LoggedInterceptor implements Serializable {
    ...
    static {
        try {
            FileHandler fileHandler = new FileHandler("C:\\Users\\Gheorghita\\Desktop\\Java Tehnologies\\l7\\src\\main\\resources\\logs\\logs.txt");
    ...
    public Object logMethodEntry(InvocationContext invocationContext) throws Exception {
        ...
        logger.log(Level.INFO, "Username: " + userSessionBean.getLoggedInUsername());
        try {
